...
export const DASHBOARD_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    group: "today",
    priority: 4,
    summary: "Entradas, saidas, vencimentos e alertas financeiros em um unico fluxo.",
    attentionLabel: "Contas vencidas, proximos pagamentos e plataformas criticas",
    nextActionLabel: "Registrar lancamento ou fechar um pagamento pendente",
    riskLabel: "Recebimentos atrasados e despesas proximas sem revisao",
    primaryActionLabel: "Novo lancamento",
    primaryActionPath: "/financeiro?compose=entry",
